...
// 3.charat same as at method (It  only support Character)
let charAt = 'Adnan Belim'
console.log(charAt.charAt(2))

// 4.charCodeat Return the ASCII value
...
// 9.fromcharcode return the word from the ASCII or sky
let fromcharcode = 97
...
// 16.padstart (it fill the value in starting of str which we give)
let padstart = 'fayyaz'
console.log(padstart.padStart(10,'k'));


// 16.padend (it fill the value in ending of str which we give)
let padend = 'fayyaz'
...
// 20.search (If element will find in str than it return the  index value of it)
let search ='hey ABCD'
...
// 22.split (It convert into array)
let split = 'hello hey'
